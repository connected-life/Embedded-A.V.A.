...
setup(
    ...
    version='0.0.1',
    description='Embedded-A.V.A. is an open source \'embedded firmware of A.V.A. and remote access point to A.V.A.\' project via raspberry Pi embedded computer',

    long_description=long_description,
    long_description_content_type='text/markdown',

    # The project's main homepage.
    url='https://github.com/MCYBA/Embedded-A.V.A..git',
    ...
    classifiers=[
        ...
        'Intended Audience :: End Users/Embedded Systems',
        'Topic :: Scientific/Engineering :: Embedded Human Machine Interfaces',
    ...
    keywords='embedded system augmented virtual assistant machine learining artifical intelligence chat bot',
    ...
    entry_points={
        'console_scripts': [
            'embedded_ava=embedded_ava:initiate',
        ],
    }
    # ext_modules=[
