...
.. module:: test_ava
    :platform: Unix
    :synopsis: test module for the top-level module of Embedded-A.V.A..

.. moduleauthor:: Mehmet Mert Yıldıran <mert.yildiran@bil.omu.edu.tr>
"""

from ava import VirtualAssistant, greet
from ava.utilities import TextToAction
...
def virtual_assistant():
    """Returns a :class:`ava.VirtualAssistant` instance."""
